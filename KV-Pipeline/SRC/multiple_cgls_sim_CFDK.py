...
MAIN_SCRIPT = "main.py"
BASE_CFG = "config_simulated_small_cfdk.cfg"
# BASE_CFG = "config_simulated_1p3.cfg"
TMP_CFG = "_cfdk_tmp_config.cfg"
...
for niter in ITERATIONS:
    ...
    # ------------------------------------------------------
    exp_root = (
        f"../Simulated_Scene_small_Iso1.3mm_Algo_ChunkFDK_/"
        # f"../Simulated_Scene_Iso1.3mm_Algo_FDK_/"
        f"CGLS_{niter}"
    )
